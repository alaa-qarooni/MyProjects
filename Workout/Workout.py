...
def parse_text(text):
    ...
    return {
        ...
        'Weight': weight.group(2) if weight.group(2) else weight.group(3) if weight.group(3) else weight.group(6)
    }

# Directory containing the images (current directory in this case)
